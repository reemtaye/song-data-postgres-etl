...
songplay_table_create = ("""
	CREATE TABLE IF NOT EXISTS songplays (
		...
		start_time time, user_id varchar, 
		level varchar,song_id varchar, 
		artist_id varchar, session_id bigint, 
...
song_table_create = ("""
	CREATE TABLE IF NOT EXISTS songs (
		...
		title varchar, artist_id varchar, year smallint, duration numeric)
""")
...
time_table_create = ("""
	CREATE TABLE IF NOT EXISTS time (
		...
		hour smallint, day smallint, week smallint, month smallint, year smallint, weekday smallint)
""")
